...
## Паспорт проекта (архитектура и онбординг)

Полное описание стека, структуры, ключевых алгоритмов и **журнал правок**: **[docs/PROJECT_PASSPORT.md](docs/PROJECT_PASSPORT.md)**.  
Его нужно дополнять при существенных изменениях — чтобы новый чат, другой разработчик или агент быстро понимали контекст.
...
Что коммитить, какие env задать, Docker и ручная сборка: **[DEPLOY.md](DEPLOY.md)**.
