...
├── bot/                 # Telegram-бот
├── tools/
│   └── multiplayer-sandbox/  # см. §10 — НЕ часть прод-сборки
├── docs/
...
| `/friends` | Список друзей, удаление, вход в лобби друга по инвайту |
...
## 10. Инструменты разработки (не прод)
...
## 12. Журнал изменений (архив правок по сессиям)
...
## 13. Инструкция для агента / разработчика

1. Перед крупной задачей **прочитайте этот файл** и затронутые модули в `server/` и `app/`.
2. После изменения логики комнат, Элиаса, лобби или структуры API — **обновите соответствующий раздел** и **строку в журнале**.
